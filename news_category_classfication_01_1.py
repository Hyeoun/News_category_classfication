# -*- coding: utf-8 -*-
"""prj01_news_category_classfication_01_1.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/14tWZ1WYQNQv-5Xjpu3iPpVKytUoNfNTA
"""
...
# resp = requests.get(url, headers = headers)  # 리퀘스트 요청을 받아온다.
...
# # print(soup)
#
# title_tags = soup.select('.cluster_text_headline')  # 클래스 이름으로 접근
# print(title_tags)
# print(type(title_tags[0]))
#
# titles = []
# for title_tag in title_tags:
#   titles.append(re.compile('[^가-힣|a-z|A-Z ]').sub(' ', title_tag.text))  #숫자는 학습에 도움이 안되니 뺀다.
# print(titles)
# print(len(titles))
#
...
print(df_titles.head())
#
df_titles.to_csv('./crawling/naver_headline_news{}.csv'.format(datetime.datetime.today().strftime('%Y%m%d')), index=False)